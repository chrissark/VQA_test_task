...
tr_image_dir = 'C:/Users/Admin/Documents/9_sem/VQA/Images/abstract_v002/train2015'
va_image_dir = 'C:/Users/Admin/Documents/9_sem/VQA/Images/abstract_v002/val2015'
tr_out_dir = './data/tr_enc'
va_out_dir = './data/va_enc'
...
tr_img_dataset = VqaImgDataset(image_dir=tr_image_dir, name='train', img_prefix="abstract_v002_train2015_")
tr_img_dataset_loader = DataLoader(tr_img_dataset, batch_size=50, shuffle=False)

va_img_dataset = VqaImgDataset(image_dir=va_image_dir, name='val', img_prefix="abstract_v002_val2015_")
va_img_dataset_loader = DataLoader(va_img_dataset, batch_size=50, shuffle=False)
