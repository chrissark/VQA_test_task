...
class SimpleBaselineExperimentRunner(ExperimentRunnerBase):
    ...
    def __init__(self, train_image_dir, train_question_path, train_annotation_path,
        ...
        tr_ques_ids = np.load('./data/tr_ques_ids.npy', encoding='latin1').tolist()
        ...
        #va_ques_ids = np.load('./data/va_ques_ids_orig.npy', encoding='latin1').tolist()

        #va_ques_ids_complete = np.load('./data/va_ques_ids_orig.npy', encoding='latin1').tolist()
